            ...
            <div className='bg-[#351b26] h-screen'>
                <div>
                    <button
                        type='button'
                        onClick={() => navigate('/')}
                        className='bg-red-900 float-end mt-2 mr-2 text-gray-300 hover:bg-[#351b26] border rounded-lg p-1.5 focus:outline-none focus:ring-1 focus:ring-yellow-200'
                    >
                        Home
                    </button>
                </div>
                <div className='pt-12'>
                    <form onSubmit={getUser} className='flex gap-2 justify-center items-center mt-8'>
                        <input
                            type='email'
                            name='email'
                            value={email}
                        ...
                        <button
                            type='submit'
                            className='w-24 text-gray-300 border rounded-lg p-1.5 bg-red-900 hover:bg-[#351b26] focus:outline-none focus:ring-1 focus:ring-yellow-200'
                        >
                            Get Details
                        </button>
                    </form>
                ...
                <div className="flex flex-wrap justify-center bg-[#351b26] mt-8">
                    {loading ? (
                        ...
                        <div className='text-gray-300 mt-4'>{error}</div>
                    ) : (
                        user.map((person, index) => (
                            <Fade key={index}>
                                <div className="w-96 mx-4 mb-8 mt-8">
